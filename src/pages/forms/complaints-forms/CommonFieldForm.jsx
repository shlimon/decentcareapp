...
const CommonFieldForm = ({ type }) => {
   ...
   const onSubmit = (data) => {
      console.log('Common Fields Submitted ✅:', data);
   };

   const reporterAnonymousOptions = [
      {
         value: 'No, you can have my details (Recommended - allows us to update you)',
         label: 'No, you can have my details (Recommended - allows us to update you)',
      },
      {
         value: 'Partially anonymous (Contact me, but keep my identity confidential from others)',
   ...
   return (
      <FormProvider {...methods}>
         <div className="px-4 max-w-xl mx-auto bg-white pt-8">
                  ...
                  render={({ field }) => (
                     <Radio
                        ...
                        options={[
                           ...
                           {
                              value: 'No',
                              label: "No, but I'm raising this in the participant's best interest",
                           },
                        ]}
                  ...
                  render={({ field }) => (
                     <Radio
                        ...
                        options={[
                           {
                              value: 'Yes',
                              label: 'Yes, keep my details confidential from the investigation',
                           },
                           {
                              value: 'No',
