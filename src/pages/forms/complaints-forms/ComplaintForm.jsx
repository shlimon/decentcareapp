          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div>
              ...
              <ul className="list-disc text-gray-700 mb-6 pl-6">
                <li>
                  We can investigate anonymous complaints, but we may not be
                  able to update you on progress.
                </li>
                <li>
                  We recommend providing at least a way to contact you, which we
                  will keep confidential.
                </li>
                <li>
                  If your complaint involves serious safety concerns, we may
                  still need to take action even if anonymous.
                </li>
              </ul>
            </div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Text
                        ...
                        error={errors.supportPerson?.relationOther?.message}
                      />
                    )}
                  />
                )}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Text
                        ...
                        label="Please specify"
                        placeholder="Please type another option here"
                        error={errors.reasonNotResolvedOther?.message}
                      />
                    )}
                  />
                )}
                ...
                <Radio
                  ...
                  options={[
                    ...
                    },
                    {
                      value: 'Moderate',
                      label:
                        'Moderate - Caused some distress or disruption to my life/services',
                    },
                    {
                      value: 'Significant',
                      label:
                        'Significant - Caused considerable distress or major disruption',
                    },
                    {
                      value: 'Severe',
                      label:
                        'Severe - Caused serious harm or major ongoing impact',
                    },
                    {
                      value: 'Critical',
                      label:
                        'Critical - Caused severe harm, trauma, or danger to my safety',
                    },
                  ]}
