        ...
        content={
          selectedData && (
            <div className="p-4 space-y-3">
              ...
              {/* ✅ Evidence File */}
              {selectedData?.evidenceFile && (
                <div className="mt-4">
                  <p className="font-semibold mb-2">Evidence Document</p>

                  <DocumentViewer
                    document={{ documentUrl: selectedData.evidenceFile }}
              ...
              {selectedData?.reviewer?.reviewedBy && (
                <div className="mt-4 p-4 bg-gray-50 border rounded-lg space-y-2">
                  ...
                  {selectedData.reviewer.reviewedAt && (
                    <p>
                  ...
                  {selectedData.reviewer.reason && (
                    <p className="text-red-600">
                      <strong>Reason:</strong> {selectedData.reviewer.reason}
                    </p>
                  )}
                </div>
              )}
