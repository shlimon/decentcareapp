            ...
            <div className="w-full max-w-md space-y-6">
               ...
               <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <button
                     ...
                     className="w-full rounded-md bg-blue-700 px-4 py-2 text-white transition hover:bg-blue-800 cursor-pointer disabled:bg-gray-400 disabled:cursor-not-allowed"
                  >
