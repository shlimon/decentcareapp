...
const ConflictList = () => {
    ...
    if (!conflictList || conflictList.length === 0) {
        return (
            <div className="text-center py-10">
                <p className="text-gray-600 mb-4">No Conflict of Interest reports found</p>
            </div>
        );
    }
                    ...
                    <div className="flex justify-between items-start">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-gray-500">
                                Raiser: <span className="font-medium">{item.conflictRaiser?.name || "—"}</span>
                            </p>
                            <p className="text-xs text-gray-500">
                                Date: <span className="font-medium">{formatDate(item.occurDate)}</span>
                            </p>
                        </div>
