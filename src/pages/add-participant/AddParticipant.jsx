      ...
      <div className="detail-box-wrapper !h-auto">
        ...
        <div className="w-full mt-2.5">
          <form onSubmit={handleSubmit(handleUserData)}>
            ...
            <div>
              <label htmlFor="anyWitnesses">Were there any witnesses?</label>
              <label>
                <div>
                  <input
                    type="radio"
            ...
            <div className="w-full mt-3.5 mb-2.5">
              <p className="mb-1 text-m text-gray-700">
                ...
                to property or equipment (include: leading up to the event, the
                actual event, and any equipment, work practices, tasks, or
                processes that may have been involved -upload a separate sheet
                if necessary)
              </p>
