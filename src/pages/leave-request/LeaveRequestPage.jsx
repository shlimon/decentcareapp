  ...
  if (error) {
    return (
      <div className="text-center py-10">
        <p className="text-red-600 font-medium">Failed to load leave data</p>
      </div>
    );
  }
    ...
    <div className="max-w-xl mx-auto">
      <div className="w-full max-w-[800px] rounded-xl font-montserrat p-6 bg-white h-full space-y-4">
        ...
        <div className="bg-white border border-gray-300 rounded-lg shadow-sm p-4">
          ...
          <p className="text-[14px] text-gray-500 mb-3">Remaining Balance</p>
        ...
        >
          ...
          <p className="text-[18px] font-bold text-[#3086F3]">Annual Leave</p>
        </div>
