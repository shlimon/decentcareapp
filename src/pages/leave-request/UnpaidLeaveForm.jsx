...
const UnpaidLeaveForm = () => {
   ...
   const navigation = () => navigate(`/work/leave-request/unpaid`);
   ...
   const onSubmit = async (data) => {
      try {
         ...
         if (response.data.success) {
            ...
            toast.error(
               response.data.message || 'Failed to submit unpaid leave request',
            );
         }
      } catch (error) {
         console.error('Error submitting unpaid leave request:', error);
         toast.error(
      ...
      <div className="">
         <FormProvider {...methods}>
            <div className="py-8 px-4 max-w-xl mx-auto bg-white space-y-4">
               <BreadCrumb
                  currentPage="Unpaid Leave Form"
                  prevPage="Unpaid Leave"
