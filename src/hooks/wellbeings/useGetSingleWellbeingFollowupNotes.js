...
const useGetSingleWellbeingFollowupNotes = (staffId, followUpId) => {
  return useQuery({
    queryKey: ['wellbeing-followup-notes-single'],
    queryFn: async () => {
      const response = await axiosInstance.get(`/wellbeings/${staffId}/my-wellbeings/${followUpId}`);
...
export default useGetSingleWellbeingFollowupNotes;
