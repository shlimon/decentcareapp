  ...
  const onSubmit = async (data) => {
    try {
      ...
      const payload = {
        ...
        equipmentDetails: data.equipmentInvolved ? data.equipmentDetails : null,
      ...
      if (hasFiles) {
        ...
        toast.success('WHS Report with evidence submitted successfully!');
      } else {
        //  application/json
        ...
        toast.success('WHS Report submitted successfully!');
      }
        ...
        <FormProvider {...methods}>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4">
              <h5 className="text-gray-800 flex items-start">Location</h5>
