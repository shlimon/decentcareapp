      ...
      <div className="py-8 px-4 max-w-xl mx-auto bg-white">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="text-sm text-gray-700 p-4 rounded-lg">
            ...
            give consent to Decent Care to use and retain the image/ video is
            attached for advertising purposes including, Decent Care's website,
            Social Media (Facebook, Instagram, Twitter), and print advertising
            material.
            <br />
            I understand that I may withdraw this consent at any time by
            advising Decent Care and my photo/video will be removed or destroyed
            at this time.
            <br />I understand that by giving consent, Decent Care can use the
            image/ recordings to promote their activities. Decent Care may
            reproduce the image or video in any form, in whole or part, and
            distribute it by any medium including printed material, the
            internet, or multimedia.
            <br />
            I understand that Decent Care:
            <br />
            Will not pay me for giving consent or for the use of this image or
            recording Will return or destroy images or recordings if I withdraw
            my consent
          </div>
          ...
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <File
                ...
                accept={['image/*', 'video/*', '.jpg', '.jpeg', '.png', '.mp4']}
