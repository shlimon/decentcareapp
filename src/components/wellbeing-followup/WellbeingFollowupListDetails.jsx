...
const WellbeingFollowupListDetails = () => {
  ...
  return (
    <>
      <div className="w-full max-w-[900px] mx-auto font-montserrat p-4 space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-300 overflow-hidden">
          ...
          <div className="px-4 py-6 space-y-4">
            {data.previousMeetingsFollowupQuestions?.length > 0 ? (
              ...
              <div>No previous meetings follow-up questions available.</div>
            )}
          </div>
        </div>
        ...
        <ModalWithContent
          ...
          content={
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              >
                {updatePending || isSubmitting ? 'Saving Note...' : 'Save Note'}
              </button>
            </form>
          }
        />
